...
Данное приложение было разработано как пет-проект. Android-приложение для просмотра текущей погоды и прогноза с использованием [WeatherAPI.com](https://www.weatherapi.com/).
